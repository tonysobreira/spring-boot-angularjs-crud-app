	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        <label class="col-md-1 control-lable" for="uname">Name</label>
	                        <div class="col-md-4">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        <label class="col-md-1 control-lable" for="age">Age</label>
	                        <div class="col-md-4">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        <label class="col-md-1 control-lable" for="salary">Salary</label>
	                        <div class="col-md-4">
